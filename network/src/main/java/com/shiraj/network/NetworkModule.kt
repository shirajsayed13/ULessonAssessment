...
import com.shiraj.network.service.lesson.AppLessonWS
import com.shiraj.network.service.lesson.RetrofitLessonWebService
import dagger.Binds
...
internal object NetworkModule {
    ...
    @Provides
    @Singleton
    internal fun provideRetrofitLessonWebService(retrofit: Retrofit): RetrofitLessonWebService =
        retrofit.create(RetrofitLessonWebService::class.java)
    ...
    internal interface AppWebService {
        @Binds
        @Singleton
        abstract fun bindLessonWebService(service: AppLessonWS): LessonWS
    }
